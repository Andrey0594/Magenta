...
namespace Magenta.Classes.Model
{
    public class MyData
    {
        public MyUrl Url;
        ...
        private string GetCutUrl(string url)
        {
        ...
        {
            string tempUrl = GetCutUrl(Url.Url);
        ...
        {
            int totalLength = urlLength + cardLength+18;
            if (urlLength + cardLength + 18 > 255)
                totalLength = urlLength + cardLength + 21;
            if (urlLength < 256)
            {
